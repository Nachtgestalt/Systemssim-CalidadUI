...
@Component({
  selector: 'app-auditoria-procesos-consulta',
  templateUrl: './auditoria-procesos-consulta.component.html',
  styleUrls: ['./auditoria-procesos-consulta.component.css']
})
export class AuditoriaProcesosConsultaComponent implements OnInit {
  ...
  ngOnInit() {
    $('#lblModulo').text('Procesos especiales - Consulta Auditoría');
