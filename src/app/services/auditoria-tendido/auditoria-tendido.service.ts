...
export class AuditoriaTendidoService {
  ...
  createAuditoria(auditoria) {
    const url = `${this.URL_AUDITORIA}/NuevaAuditoriaCorteTendido`;
  ...
  getAuditoriaDetail(id, tipo?) {
    const url = `${this.URL_AUDITORIA}/ObtieneAuditoriaTendido`;
    const headers = new HttpHeaders().append('content-type', 'application/json');
  ...
  updateAuditoria(auditoria) {
    const url = `${this.URL_AUDITORIA}/AuditoriaTendido`;
    const body = JSON.stringify(auditoria);
    const headers = new HttpHeaders().append('content-type', 'application/json');
  ...
  cierreAuditoria(id) {
    const url = `${this.URL_AUDITORIA}/CierreAuditoriaTendido`;
    const headers = new HttpHeaders().append('content-type', 'application/json');
  ...
  deleteAuditoria(id) {
    const url = `${this.URL_AUDITORIA}/EliminaAuditoriaTendido`;
    const headers = new HttpHeaders().append('content-type', 'application/json');
    const params = new HttpParams().append('ID', id);
