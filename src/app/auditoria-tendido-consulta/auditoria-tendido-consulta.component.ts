...
@Component({
  selector: 'app-auditoria-tendido-consulta',
  templateUrl: './auditoria-tendido-consulta.component.html',
  styleUrls: ['./auditoria-tendido-consulta.component.css']
})
export class AuditoriaTendidoConsultaComponent implements OnInit {
  ...
  ngOnInit() {
    $('#lblModulo').text('Corte - Consulta Auditoría Tendido');
